...
namespace MuonLab.Web.Xhtml.Example.Net47
{
	public static class HtmlHelperExtensions
	{
		...
		/// </summary>
		/// <returns></returns>
		public static HtmlString BeginForm<T>(this HtmlHelper<T> html)
		{
		...
		/// </summary>
		/// <returns></returns>
		public static HtmlString BeginForm<T>(this HtmlHelper<T> html, object attributes)
		{
		...
		/// </summary>
		/// <returns></returns>
		public static HtmlString BeginForm<TFormConfiguration, T>(this HtmlHelper<T> html) where TFormConfiguration : IFormConfiguration, new()
		{
		...
		/// </summary>
		/// <returns></returns>
		public static HtmlString BeginForm<TFormConfiguration, T>(this HtmlHelper<T> html, object attributes) where TFormConfiguration : IFormConfiguration, new()
		{
			if (html.ComponentFactory() != null)
		...
		public static HtmlString EndForm<T>(this HtmlHelper<T> html)
		{
		...
		static IComponentFactory<TViewData> CreateComponentFactory<TViewData, TFormConfiguration>(this HtmlHelper<TViewData> html) where TFormConfiguration : IFormConfiguration, new()
		{
			...
			var errorProvider = new ModelStateDictionaryErrorProvider(html.ViewData.ModelState);
		...
		public static IFileUploadComponent FileUploadFor<TViewModel>(this HtmlHelper<TViewModel> html, Expression<Func<TViewModel, IFormFile>> property)
		{
		...
		/// <param name="html"></param>
		/// <returns></returns>
		public static HtmlString ValidationSummary<TViewModel>(this HtmlHelper<TViewModel> html)
		{
		...
		/// <returns></returns>
		public static HtmlString ValidationSummary<TViewModel>(this HtmlHelper<TViewModel> html, ValidationSummaryMode mode)
		{
		...
		/// <param name="mode">The error display mode</param>
		/// <returns></returns>
		public static HtmlString ValidationSummary<TViewModel>(this HtmlHelper<TViewModel> html, string headerText, ValidationSummaryMode mode)
		{
